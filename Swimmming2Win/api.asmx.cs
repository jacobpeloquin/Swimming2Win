...
namespace WebAPI {
    ...
    public class api : System.Web.Services.WebService {
        ...
        [WebMethod]
        public void getSetDetailsbyUserID(int userID)
        {
            addParam("@userID", userID);
            send("spGetSetDetailsbyUserID", serializeStyle.JSON_RETURN);
        }

        [WebMethod]
        public void getSetDetailsbyUserName(String userName)
        {
            addParam("@userName", userName);
            send("spGetSetDetailsbyUserName", serializeStyle.JSON_RETURN);
        }

        //[WebMethod]
        //public void getUserPastLocationsByState(int userID, string state )
        //{
        //    addParam("@userID", userID);
        //    addParam("@state", state); 
        //    send("spgetUserPastLocationsByState", serializeStyle.JSON_RETURN);
        //}

        //[WebMethod]
        //public void getUserPastLocationsByCity(int userID, string city)
        //{
        //    addParam("@userID", userID);
        //    addParam("@city", city);
        //    send("spgetUserPastLocationsByCity", serializeStyle.JSON_RETURN);
        //}

        [WebMethod]
        public void getLocationsByCity(string city)
        {
            addParam("@city", city);
            send("spGetLocationsByCity", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void getWorkoutsByLocationName(string locName)
        {
            addParam("@locName", locName);
            send("spGetWorkoutsByLocationName", serializeStyle.JSON_RETURN);
        }

        [WebMethod]
        public void getUsersLocationsByUserID(int userID)
        {
            addParam("@userID", userID);
            send("spGetUsersLocationsByUserID", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void getUserList(int page)
        {
            addParam("@page", page);
            send("spGetUserList", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void getWorkoutDetails(int uid)
        {
            addParam("@userID", uid);
            send("spGetWorkoutDetails", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void getUsersWithsameWorkouts(string workoutName)
        {
            addParam("@workoutName", workoutName);
            send("spGetUsersWithsameWorkouts", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
                            ...
                            string gender )
        {
            ...
            send("spAddUser", serializeStyle.JSON_RETURN);
            
        }
        [WebMethod]
        public void addWorkout  (string workoutTitle,
                                 string workoutDate,
                                 int    userID,
                                 int    locationID)
        {
            addParam("@workoutTitle", workoutTitle);
            addParam("@workoutDate", workoutDate);
            addParam("@userID", userID);
            addParam("@locationID", locationID);
            send("spAddWorkout", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void addWorkoutSet(int workoutID,
                                  string setName,		
                                  int setTime,		
                                  int distance,		
                                  string setDescription)
        {
            addParam("@workoutID", workoutID);	
            addParam("@setName",setName);
            addParam("@setTime",setTime);
            addParam("@distance", distance);
            addParam("@setDescription", setDescription);
            send("spAddWorkoutSet", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void addLocation (string locationName,
                                 ...
                                 string poolType)		
        {
            addParam("@locationName",locationName);	
            addParam("@address",address	);
            addParam("@city",city);	
            addParam("@state",state);	
            addParam("@poolType",poolType);
            send("spAddLocation", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void getUserspastWorkoutsbyDate(string date, int userID)
         {
             addParam("@workoutDate", date);
             addParam("@userID", userID);
             send("spGetUsersPastWorkoutsByDate", serializeStyle.JSON_RETURN);
         }
        ...
        public void getUserIdByEmail(string email)
        {
            ...
            send("spGetUserIdByEmail", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void deleteUser(int userID)
        {
            addParam("@userID", userID);
            send("spDeleteUserbyUserID", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void deleteLocation(int locationID)
        {
            addParam("@locationID", locationID);
            send("spDeleteLocationbylocationID", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void deleteWorkout(int workoutID)
        {
            addParam("@workoutID", workoutID);
            send("spDeleteWorkoutbyWorkoutID", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void deleteWorkoutSet(int workoutSetID)
        {
            addParam("@workoutSetID", workoutSetID);
            send("spDeleteSetbySetID", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
                                 ...
                                 string poolType)
        {
            ...
            addParam("@state", state);
            addParam("@poolType", poolType);
            send("spUpdateLocations", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
                            ...
                            string gender)
        {
            ...
            addParam("@lName", lastName);
            addParam("@gender", gender);
            send("spUpdateUsers", serializeStyle.JSON_RETURN);

        }
        [WebMethod]
        public void updateWorkout(int workoutID,
                                 string workoutTitle,
                                 string workoutDate,
                                 int userID,
                                 int locationID)
        {
            ...
            addParam("@userID", userID);
            addParam("@locationID", locationID);
            send("spUpdateWorkouts", serializeStyle.JSON_RETURN);
        }
        [WebMethod]
        public void updateWorkoutSet(int workoutSetID,
                                  int workoutID,
                                  string setName,
                                  int setTime,
                                  int distance,
                                  string setDescription)
        {
            ...
            addParam("@distance", distance);
            addParam("@setDescription", setDescription);
            send("spUpdateWorkoutSets", serializeStyle.JSON_RETURN);
        }
    }  
}      